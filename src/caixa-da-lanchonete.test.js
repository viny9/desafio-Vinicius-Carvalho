...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['dinheiro', 'R$ 10,93', ['cafe,1', 'sanduiche,1', 'queijo,1']],
    ...
    test.each([
        ...
        ['combo1 e combo2', 'dinheiro', 'R$ 16,15', ['combo1,1', 'combo2,1']]
    ])('compra %p em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    test.each([
        ...
        ['sem forma de pagamento', '', 'Forma de pagamento inválida!', ['cafe, 1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
